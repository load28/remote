...
| file_path | `{layer}/{slice}/model/___Atoms.ts` | FSD model 세그먼트 [A-02]. 예: `features/chat/model/chatAtoms.ts`, `entities/user/model/userAtoms.ts` |
...
| computation | `(get) => ___` | 순수 함수, 부수효과 금지 |
...
□ Design Guard 4항목 전부 확인 (해당/해당없음 명시)
