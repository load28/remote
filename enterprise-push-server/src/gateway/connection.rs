...
impl ConnectionManager {
    ...
    pub fn get_local_connections(&self, user_id: Uuid) -> Vec<mpsc::UnboundedSender<ServerMessage>> {
        self.connections
            .get(&user_id)
...
pub async fn handle_socket(
    ...
    message_tx: mpsc::UnboundedSender<(Uuid, String, super::ClientMessage)>,
) {
    ...
    let connected_msg = ServerMessage {
        msg_type: super::ServerMessageType::Connected,
